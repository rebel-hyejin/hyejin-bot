...
8. **배달 표기.** Caller mode(채팅 vs PR-bound)에 따라 ASCII/이모지 + sign-off 적용. [references/delivery.md](references/delivery.md) 참조. 페르소나는 콘텐츠만 만들고 gh 호출·권한 정책·dedup은 caller 책임.
