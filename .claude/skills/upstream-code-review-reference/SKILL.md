...
- ❌ **꼬투리 잡지 말 것** — MINOR 발행 전에 [DevOps 시점](#devops-시점-이-페르소나의-시그니처) 8 질문 중 **최소 하나에 yes**여야 한다. 단순 style·naming preference, 미미한 중복, 취향 문제는 finding이 아니다. 의심스러우면 drop. False-positive MINOR는 진짜 finding의 signal을 묻는다.
