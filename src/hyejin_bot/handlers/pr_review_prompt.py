...
OUTPUT_DIRECTIVE = (
    ...
    " then — when findings >= 1 — a one-line severity count directly under"
    " the Verdict: `🚨 N CRITICAL · ⚠️ M MAJOR · 💡 K MINOR` (omit any"
    " zero-count severity; omit the whole line when findings == 0). This"
    " line is the only place emoji is allowed in a PR-bound body — it's a"
    " scannable meta summary, not prose. Then 개요 (2-3 Korean sentences"
    " plain walkthrough),"
